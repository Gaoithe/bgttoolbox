...
#[omn@vb-28] vi ~/.ssh/authorized_keys #place local pub key(by ssh-keygen) and remote pub key in here 
   ...
   scp ~/bin/run_uninstall_TC.sh omn@vb-28:scripts/
   scp ~/bin/run_uninstall_TC.sh omn@vb-48:scripts/
   scp ~/bin/run_install_TC.sh omn@vb-28:scripts/
   scp ~/bin/run_install_TC.sh omn@vb-48:scripts/
   scp ~/bin/run_solo_start_TC.sh omn@vb-28:scripts/
   scp ~/bin/run_rejoin_TC.sh omn@vb-48:scripts/
