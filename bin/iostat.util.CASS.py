...
plot_string_io = 'plot "/tmp/io"  using 0:1 title "sda util%", "/tmp/io"  using 0:2 title "sdb /apps util%", "/tmp/io"  using 0:3 title "sdc /commit util%", "/tmp/io"  using 0:4 title "sdd /data util%", "/tmp/io"  using 0:5 title "sde /logs util%", "/tmp/io"  using 0:6 title "sdf util%"'
plot_string_io = 'plot "/tmp/io"  using 0:3 title "sdc /commit util%", "/tmp/io"  using 0:4 title "sdd /data util%"'
plot_string_io = 'plot "/tmp/io"  using 0:1 title "sda util%", "/tmp/io"  using 0:2 title "sdb /apps util%", "/tmp/io"  using 0:3 title "sdc /commit util%", "/tmp/io"  using 0:4 title "sdd /data util%", "/tmp/io"  using 0:5 title "sde /logs util%", "/tmp/io"  using 0:6 title "sdf util%", "/tmp/io"  using 0:7 title "dm-0 util%", "/tmp/io"  using 0:8 title "dm-1 util%", "/tmp/io"  using 0:9 title "dm-2 util%", "/tmp/io"  using 0:10 title "dm-3 util%", "/tmp/io"  using 0:11 title "dm-4 util%", "/tmp/io"  using 0:12 title "dm-5 util%"'
