...
test
[james@nebraska c]$ java DirProcess
File: ims, is sym link? false
File: ., is sym link? true
File: file.txt, is sym link? false
File: symlink, is sym link? false
[james@nebraska c]$ touch file.txt
[james@nebraska c]$ ln -s file.txt symlink
[james@nebraska c]$ mkdir ims
[james@nebraska c]$ java DirProcess
File: ims, is sym link? false
File: ., is sym link? true
File: file.txt, is sym link? false
File: symlink, is sym link? true


How do we build libcvsclient ?? Part of CVS plugin that does the cvs update. libcvsclient == part of netbeans.
Can build from jenkins source?
Or netbeans source?
Or mclarke forked netbeans libcvsclient and there is a github repo.

https://github.com/mc1arke/cvsclient/
https://github.com/mc1arke/cvsclient/tree/master/src/main/java/org/netbeans/lib/cvsclient/command
