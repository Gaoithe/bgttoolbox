...
alert("TODO move r/l u/d with !|_<>[]{}() or button. TODO Display name. TODO Display maybe/nope mask. TODO Sel grp/sq. TODO when load make nums bold.");
 }
